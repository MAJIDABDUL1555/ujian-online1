...
// cek  apakah siswa sudah mengikuti ujian
          ...
          <div class="row">
            <div class="col-md-12 grid-margin mb-3">
              <div class="d-flex justify-content-between align-items-center">
                ...
                <div>
                    <a href="soal.php" onclick="return confirm('anda yakin akan mulai mengerjakan ujin ?')" class="btn btn-warning btn-icon-text btn-rounded">
